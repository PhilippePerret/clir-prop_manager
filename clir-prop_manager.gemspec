...
Gem::Specification.new do |s|
  s.name          = "clir-prop_manager"
  s.version       = Clir::PropManager::VERSION
  ...
  s.homepage      = "https://github.com/PhilippePerret/clir-prop_manager"
  s.required_ruby_version = Gem::Requirement.new(">= 2.3.0")

  s.metadata["allowed_push_host"] = "https://github.com/PhilippePerret/clir-prop_manager"
  ...
  s.metadata["source_code_uri"] = "https://github.com/PhilippePerret/clir-prop_manager"
  s.metadata["changelog_uri"] = "https://github.com/PhilippePerret/clir-prop_manager/CHANGELOG.md"
